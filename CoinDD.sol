...
library Utils {
    ...
    function isLotteryWon(uint256 salty, uint256 _winningDoubleRewardPercentage) private view returns (bool) {
    ...
    function calculateBNBReward(
        ...
        bool isLotteryWonOnClaim = isLotteryWon(currentBalance, _winningDoubleRewardPercentage);
        ...
        uint256 reward = bnbPool.mul(multiplier).mul(currentBalance).div(100).div(ttlSupply);
...
contract CoinDD is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    //charityAddress
    address payable public charityAddress = 0x68A12862A45d1497bd66243b67934aa706DA2Ba6;
    ...
    string private _name = "CoinDD";
    string private _symbol = "CDD";
    ...
    /**
     *  Innovation for protocol by CoinDD Team
     */
    ...
    uint256 public disruptiveCoverageFee = 1 ether; // Destructive insurance costs
    ...
    uint256 public winningDoubleRewardPercentage = 5;// Earn a double bonus percentage
    ...
    uint256 public rewardThreshold = 1 ether;// Reward threshold
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own COINDD to claim reward');
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 1 days;//weeks
        ...
        setMaxTxPercent(20);// 100 means 1% and 50 means 0.5%  and 1 means 0.01% 
